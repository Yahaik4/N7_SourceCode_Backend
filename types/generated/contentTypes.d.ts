...
export interface ApiInvoiceInvoice extends Schema.CollectionType {
  ...
  attributes: {
    product_names: Attribute.Relation<
      'api::invoice.invoice',
      'manyToMany',
      'api::product.product'
    >;
    ...
    state: Attribute.Enumeration<['pending', 'completed', 'cancelled']>;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    image: Attribute.Media;
    quantity: Attribute.Integer;
    sellPrice: Attribute.BigInteger;
    originalPrice: Attribute.BigInteger;
    isHot: Attribute.Boolean;
    state: Attribute.Enumeration<['available', 'unavailable']>;
    ...
    rom: Attribute.String;
    pin: Attribute.String;
    operationSystem: Attribute.String;
...
export interface ApiStaffStaff extends Schema.CollectionType {
  ...
  attributes: {
    ...
    phoneNumber: Attribute.String;
    password: Attribute.Password;
    slug: Attribute.UID<'api::staff.staff', 'phoneNumber'>;
